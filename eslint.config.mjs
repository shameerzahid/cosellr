...
const sortImportsRules = () => {
  ...
  return {
    'perfectionist/sort-named-imports': [1, { type: 'line-length', order: 'asc' }], // Changed to warning
    'perfectionist/sort-named-exports': [1, { type: 'line-length', order: 'asc' }], // Changed to warning
